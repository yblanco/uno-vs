          ...
          games.map(game => (
            <Columns.Column size={6}>
              <Columns key={game.code} className='is-mobile has-text-white is-vcentered list-game-items'>
                <Columns.Column mobile={{ size: 3 }} desktop={{ size: 2 }}>
                  {game.code}
                </Columns.Column>
                <Columns.Column mobile={{ size: 1 }} desktop={{ size: 1}}>
                  <Icons type='people' size={24} />
                </Columns.Column>
                <Columns.Column mobile={{ size: 2 }} desktop={{ size: 2 }}>
                ...
                <Columns.Column mobile={{ size: 3 }} desktop={{ size: 3 }}>
